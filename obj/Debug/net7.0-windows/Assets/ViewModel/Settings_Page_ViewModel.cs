    ...
    internal partial class Settings_Page_ViewModel : ObservableObject
    {
        ...
        private void save_settings()
        {
            ...
            else
            {
                ...
                object[] section_key_values = {Email_backup, Backup_data, Printer_name, Currency_, Value_added_tax, Quotation_template, Invoice_template, Receipt_template};
                ...
                foreach (var item in section_key_names)
                {
                    ...
                    {
                        MessageBox.Show($"Error in saving settings. please try again.");
                        break;
                    }
